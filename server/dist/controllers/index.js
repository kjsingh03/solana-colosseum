        ...
        if (email) {
            ...
            if (user) {
                ...
                user.save()
                    ...
                    .catch((err) => { res.status(404).json({ "success": false, "message": "Failed to login", "error": err.message }); });
            }
            else {
                ...
                user.save()
                    ...
                    .catch((err) => { res.status(404).json({ "success": false, "message": "Failed to signup", "error": err.message }); });
            }
        }
        else {
        ...
        if (email) {
            ...
            if (user) {
                ...
                user.save()
                    ...
                    .catch((err) => { res.status(201).json({ "success": false, "message": "Failed to logout", "error": err.message }); });
            }
            else {
